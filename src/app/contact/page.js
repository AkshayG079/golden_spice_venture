...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(
      "NEXT_PUBLIC_SERVICE_ID KEY:",
      process.env.NEXT_PUBLIC_SERVICE_ID
    );
    console.log(
      "NEXT_PUBLIC_TEMPLATE_ID KEY:",
      ...
      <div className="w-full min-h-screen overflow-hidden">
        <main className="flex-1 px-4 sm:px-6 lg:px-8 py-6 md:py-10">
          ...
          <div className="flex flex-col w-full max-w-7xl mx-auto">
            {" "}
            {/* Changed to max-w-7xl and removed max-w-full */}
            {/* Heading Section */}
            <motion.div
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {/* <span className="material-symbols-outlined text-[#6D4C41]  text-lg">
                      mail
                    </span> */}
                      <Mail className="text-[#6D4C41] w-5 h-5" />
                    </motion.div>
                  ...
                  >
                    ...
                    >
                      <Phone className="text-[#6D4C41] w-5 h-5" />
                  ...
                  >
                    ...
                    >
                      ...
                      <MapPin className="text-[#6D4C41] w-5 h-5" />
                    </motion.div>
                    <div className="flex flex-col gap-1 flex-1">
                      <p className="text-[#6D4C41] text-sm sm:text-base font-medium leading-normal">
                        Address
        ...
        >
          <motion.p
            ...
            variants={fadeInUp}
          >
            © {new Date().getFullYear()} Golden Spice Venture — All Rights
            Reserved.
          </motion.p>
        </motion.footer>
