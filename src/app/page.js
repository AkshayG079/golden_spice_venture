  ...
  return (
    <AnimatePresence mode="wait">
      ...
      <motion.div
        ...
        className="bg-[#F5F5F5] w-full min-h-screen overflow-hidden"
      >
            ...
            <main className="flex-1">
              ...
              <motion.section className="@container">
                ...
                >
                  ...
                  >
                    ...
                    >
                      Connecting you with the finest, ethically sourced
                      turmeric, straight from our farms to your business.
                    </motion.h2>
                  </motion.div>
              ...
              >
                ...
                >
                  ...
                  >
                    We are dedicated to providing the highest quality turmeric
                    while ensuring sustainable practices and fair partnerships
                    with our farmers.
                  </motion.p>
                  ...
                  {[
                    {
                      ...
                      desc: "We work directly with local farmers to bring you the most authentic and flavorful turmeric.",
                    },
                    {
                      icon: "🤝",
                      title: "Sustainable Farming",
                      desc: "Environmentally friendly and supports local ecosystem.",
                    },
                    {
                      icon: "⭐",
                      title: "Unmatched Quality",
                      desc: "Every batch undergoes rigorous quality checks.",
                    },
                  ].map((card, i) => (
                    <motion.div
                      key={i}
              ...
              >
                {[
                  ...
                  >
                    ...
                    >
                      <p className="text-[#181611] text-lg font-bold leading-normal">
                        {card.title}
                      </p>
                      <p className="text-[#897c61]  text-sm font-normal leading-normal mt-1">
                        {card.desc}
                      </p>
                    </motion.div>
                  </motion.div>
              ...
              >
                ...
                <div className="max-w-2xl mx-auto relative z-10">
                  ...
                  <motion.p
                    ...
                    transition={{ delay: 0.1 }}
                  >
                    Join us in our journey to bring the golden spice to the
