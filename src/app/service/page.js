            ...
            <div className="px-4 md:px-10 lg:px-40 flex flex-1 justify-center py-5">
                <div className="layout-content-container flex flex-col max-w-[80vw] flex-1 w-full">
                            ...
                            >
                                ...
                                >
                                    <motion.h1 
                                        ...
                                        variants={fadeInUp}
                                    >
                                        Connecting the World to the Golden Spice: Our Export & Logistics Expertise
                                    </motion.h1>
                                    <motion.h2 
                                    ...
                                    >
                                        Seamless and sustainable logistics from farm to global markets.
                                    </motion.h2>
                                </motion.div>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        >
                            {/* Step 1 */}
                            <motion.div className="flex flex-col items-center" variants={cardItem}>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <h3 className="font-bold text-lg text-[#181611] mb-2">Global Network</h3>
                            ...
                            >
                                ...
                                <h3 className="font-bold text-lg text-[#181611] mb-2">Quality Assurance</h3>
                                <p className="text-[#897c61]">
                            ...
                            >
                                ...
                                <h3 className="font-bold text-lg text-[#181611] mb-2">Fast Delivery</h3>
                                <p className="text-[#897c61]">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <h3 className="font-bold text-lg text-[#181611] mb-3">Bulk Export</h3>
                                <p className="text-[#897c61] mb-4">
                                    Large-scale turmeric export with competitive pricing and volume discounts.
                                </p>
                            ...
                            <motion.div 
                                ...
                                whileHover={{ scale: 1.02, transition: { duration: 0.2 } }}
                            >
                                <h3 className="font-bold text-lg text-[#181611] mb-3">Private Labeling</h3>
                                <p className="text-[#897c61] mb-4">
                    ...
                    >
                        <div className="text-center max-w-2xl mx-auto">
                            ...
                            >
                                Join our network of global partners and experience trusted turmeric exporting.
                            </motion.p>
                            <motion.div 
