        ...
        <main className="flex-1">
          ...
          >
            <motion.div
              ...
              style={{
                backgroundImage:
                  'linear-gradient(rgba(0, 0, 0, 0.3) 0%, rgba(0, 0, 0, 0.6) 100%), url("/img/mg-2.jpg")',
              }}
              variants={scaleIn}
            >
              <motion.div
              ...
              >
                <motion.h1
                  ...
                  variants={fadeInUp}
                >
                  From Our Farms to Your Table: The Story of Golden Spice
                  Venture
                </motion.h1>
                <motion.h2
                ...
                >
                  Discover our commitment to authenticity, sustainability and
                  quality, connecting farmers to international customers.
                </motion.h2>
              </motion.div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <motion.div
                  className="flex flex-1 flex-col pb-8 sm:pb-12"
                  variants={cardItem}
                >
                  <motion.p
                  ...
                  <motion.p
                    ...
                    transition={{ delay: 0.2 }}
                  >
                    Golden Spice Venture, established in 2025, is a dedicated
                    exporter of premium Turmeric Fingers from India. We
                    specialize exclusively in sourcing, processing and supplying
                    high-quality turmeric to meet the growing global demand for
                    this golden spice.
                    <br />
                    With a strong commitment to purity, authenticity and
                    sustainability, Golden Spice Venture ensures that every
                    turmeric finger we deliver carries the rich color, aroma and
                    natural benefits that Indian turmeric is renowned for
                    worldwide.
                    <br />
                    Our operations are backed by stringent quality checks,
                    hygienic processing and reliable logistics, ensuring timely
                    delivery to our valued international clients. At Golden
                    Spice Venture, we believe in building long-term partnerships
                    by offering not only a product but also trust, transparency
                    and consistent quality.
                    <br />
                    As a young and ambitious firm, we are driven to position
                    Indian turmeric on the global map as a symbol of health,
              ...
              >
                ...
                >
                  ...
                  <motion.span
                    ...
                    transition={{ duration: 0.6 }}
                  >
                    <Rocket className="w-10 h-10 text-[#2E7D32]" />
                  </motion.span>
                  ...
                  <p className="font-body text-base sm:text-lg">
                    To deliver the world's finest, ethically-sourced turmeric
                    while empowering our farming communities and preserving the
                    environment.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <motion.span
                    ...
                    transition={{ duration: 0.3 }}
                  >
                    <Eye className="w-10 h-10 text-[#2E7D32]" />
                  </motion.span>
                  <h3 className="text-xl sm:text-2xl font-bold mt-4 mb-2 font-display">
                    Our Vision
                  </h3>
                  <p className="font-body text-base sm:text-lg">
                    To be a global leader in sustainable turmeric export,
                    celebrated for our unwavering commitment to quality,
                ...
                >
                  ...
                  <motion.span
                    ...
                    transition={{ duration: 0.3 }}
                  >
                    <Heart className="w-10 h-10 text-[#2E7D32]" />
                  </motion.span>
                  <h3 className="text-xl sm:text-2xl font-bold mt-4 mb-2 font-display">
                    Our Values
                  </h3>
                  <p className="font-body text-base sm:text-lg">
                    Authenticity, Sustainability, Quality, Community and
                    Transparency guide every decision we make, from farm to
                    table.
                  </p>
                </motion.div>
              </motion.div>
          ...
          >
            ...
            >
              {[
                {
                  img: "/img/ladyFarmer.jpg",
                  alt: "A farmer smiling in a turmeric field.",
                  span: "col-span-1",
                },
                {
                  img: "https://lh3.googleusercontent.com/aida-public/AB6AXuDu6nuEaACWd1xSZXCtmH_vOojTAAPmQ357WgnGP9hraqY6zZIsIBwi9b5jNfJPoFy12EnFFSoVxcOJzkpyHUmWHW_CTjNMLpAsyoDPQGSGHNV8lWm5U6n1RfezKyZ1y-f9bQ-FdqT3lS1Kga4gaccnoZcMzR9NqH00x3UVOezR4hPyqVmJF9fJfE_6gKKMiwwZOawfOm3oYys6CdzS2H-hHWzL6MH3sZB_EYt1iFi91lRMEaWPLYgCad7jdaot9YFL0q5ojgBPo7o",
                  alt: "Lush green turmeric plants in a field.",
                  span: "col-span-1",
                },
                {
                  img: "/img/farmer.jpg",
                  alt: "A community of farmers together.",
          ...
          >
            <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-10 lg:px-20 text-center">
              ...
              <motion.p
                ...
                transition={{ delay: 0.1 }}
              >
                Explore our range of premium turmeric products or get in touch
